...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen overflow-hidden bg-gradient-to-b from-background via-background to-muted/30 pt-[88px] sm:pt-[96px]">
      <FloatingElements />
      ...
      <motion.div
        className="section-container relative z-10 flex min-h-[calc(90vh-88px)] md:min-h-[calc(100vh-96px)] flex-col items-center justify-center py-6 sm:py-8 md:py-12"
